...
# Location-unresolved prompt, localized like the degraded messages so a
# regional-language user is never asked for their position in English.
ASK_LOCATION = {
    "en": "I couldn't determine your location. Please enable GPS or tell me a coastal location such as Ratnagiri, Veraval, Kochi, or coordinates.",
    "hi": "मुझे आपकी स्थिति समझ नहीं आई। कृपया GPS चालू करें या कोई तटीय स्थान बताएं जैसे रत्नागिरी, वेरावल, कोच्चि, या निर्देशांक।",
    "mr": "मला तुमचे स्थान समजू शकले नाही. कृपया GPS चालू करा किंवा रत्नागिरी, वेरावल, कोची सारखे किनारपट्टीचे ठिकाण किंवा निर्देशांक सांगा.",
    "ta": "உங்கள் இருப்பிடத்தை என்னால் தீர்மானிக்க முடியவில்லை. GPS-ஐ இயக்கவும் அல்லது ரத்னகிரி, வேராவல், கொச்சி போன்ற கடலோர இடத்தைக் கூறவும் அல்லது ஆயத்தொலைவுகளைக் கொடுக்கவும்.",
    "te": "మీ స్థానాన్ని నేను గుర్తించలేకపోయాను. దయచేసి GPS ఆన్ చేయండి లేదా రత్నగిరి, వేరావల్, కొచ్చి వంటి తీర ప్రాంతాన్ని చెప్పండి లేదా నిర్దేశాంకాలు ఇవ్వండి.",
    "bn": "আপনার অবস্থান নির্ধারণ করতে পারলাম না। অনুগ্রহ করে GPS চালু করুন বা রত্নাগিরি, বেরাওয়াল, কোচি-র মতো উপকূলীয় স্থান বা স্থানাঙ্ক বলুন।",
    "ml": "നിങ്ങളുടെ സ്ഥാനം എനിക്ക് കണ്ടെത്താനായില്ല. GPS ഓണാക്കുക അല്ലെങ്കിൽ രത്നഗിരി, വേരാവൽ, കൊച്ചി പോലുള്ള തീരദേശ സ്ഥലമോ നിർദ്ദേശാങ്കങ്ങളോ പറയുക.",
    "kn": "ನಿಮ್ಮ ಸ್ಥಳವನ್ನು ನಾನು ಪತ್ತೆಹಚ್ಚಲಾಗಲಿಲ್ಲ. ದಯವಿಟ್ಟು GPS ಆನ್ ಮಾಡಿ ಅಥವಾ ರತ್ನಗಿರಿ, ವೆರಾವಲ್, ಕೊಚ್ಚಿಯಂತಹ ಕರಾವಳಿ ಸ್ಥಳ ಅಥವಾ ನಿರ್ದೇಶಾಂಕಗಳನ್ನು ತಿಳಿಸಿ.",
    "gu": "મને તમારું સ્થાન નક્કી કરી શકાયું નથી. કૃપા કરીને GPS ચાલુ કરો અથવા રત્નાગિરી, વેરાવળ, કોચી જેવું કોઈ દરિયાકાંઠાનું સ્થળ અથવા નિર્દેશાંક જણાવો.",
    "or": "ଆପଣଙ୍କ ଅବସ୍ଥାନ ମୁଁ ନିର୍ଣ୍ଣୟ କରିପାରିଲି ନାହିଁ। ଦୟାକରି GPS ଚାଲୁ କରନ୍ତୁ କିମ୍ବା ରତ୍ନଗିରି, ବେରାୱାଲ, କ୊ଚି ପରି ଉପକୂଳ ସ୍ଥାନ କିମ୍ବା ନିର୍ଦ୍ଦେଶାଙ୍କ କୁହନ୍ତୁ।",
    "pa": "ਮੈਨੂੰ ਤੁਹਾਡੀ ਸਥਿਤੀ ਪਤਾ ਨਹੀਂ ਲੱਗੀ। ਕਿਰਪਾ ਕਰਕੇ GPS ਚਾਲੂ ਕਰੋ ਜਾਂ ਰਤਨਾਗਿਰੀ, ਵੇਰਾਵਲ, ਕੋਚੀ ਵਰਗੀ ਤੱਟੀ ਥਾਂ ਜਾਂ ਨਿਰਦੇਸ਼ਾਂਕ ਦੱਸੋ।",
}
for _code, _base in _FALLBACK.items():
    if _code not in ASK_LOCATION:
        ASK_LOCATION[_code] = ASK_LOCATION.get(_base, ASK_LOCATION["en"])

def ask_location(lang: str | None) -> str:
    return ASK_LOCATION.get(_norm(lang), ASK_LOCATION["en"])
