...
#
# Single source of truth: all routing/constants live in orchestrator/state.py
# Re-exported here so `from orchestrator import X` keeps working.
from .state import (
    KNOWN_LOCATIONS,
    DEFAULT_LOCATION,
    KNOWN_TIME_WINDOWS,
